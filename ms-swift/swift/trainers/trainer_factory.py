...
class TrainerFactory:
    ...
    def get_trainer_cls(cls, args):
        if hasattr(args, 'rlhf_type') and args.rlhf_type == 'grpo' and getattr(args, 'tas_enable', False):
            module = importlib.import_module('swift.rlhf_trainers.grpo_tas_trainer')
            return getattr(module, 'GRPOTASTrainer')
